...
(function () {
  ...
  if (typeof document !== 'undefined' && !document.getElementById('cm-memo-style')) {
    ...
    st.textContent = [
      ...
      '.cm-memo-tag{display:inline-block;font-size:11px;padding:2px 8px;background:#F3F4F6;color:#374151;border-radius:6px;margin-right:4px;margin-top:4px;font-weight:600;}',
      '.cm-memo-tag--warn{background:#FEE2E2;color:#B91C1C;}',
      '.cm-memo-meta{font-size:11px;color:#9CA3AF;margin-top:4px;display:flex;align-items:center;gap:6px;}',
    ...
    if (!host) {
      ...
      host.innerHTML = [
        '<div style="display:flex;align-items:center;gap:6px;margin-bottom:8px;">',
          ...
          '<strong style="font-size:13px;">시술 메모 <span style="font-size:11px;color:#9CA3AF;font-weight:400;">(AI 자동 태그)</span></strong>',
          ...
          return [
            '<div class="', cls, '" data-cm-jump="', m.customer_id, '" style="cursor:pointer;">',
              '<div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;">',
                ...
                m.is_warning ? '<span style="font-size:11px;color:#DC2626;font-weight:700;">경고</span>' : '',
                '<span style="margin-left:auto;font-size:11px;color:#9CA3AF;">', _dateShort(m.created_at), '</span>',
              '</div>',
              '<div class="cm-memo-text">', _esc(m.text), '</div>',

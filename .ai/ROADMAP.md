...
| P2 성능 최적화 | 고객 공유 캐시, 매출 병렬 fetch, lazy loader | 🔵 예정 |
| P3 UX 간소화 | 터치 영역 48px, 예약 퀵 추가, 에러 표준화 | 🔵 예정 |
| P4 보안 강화 | AES-GCM 암호화, refresh token, CSP | 🔵 예정 |
| P5 신규 기능 | 대기리스트, 리마인더, 멤버십, AI 예측, 리뷰 수집 | 🔵 예정 |

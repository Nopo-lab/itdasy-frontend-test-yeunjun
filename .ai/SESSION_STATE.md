...
- 별도 작업 폴더: `../itdasy-release-cert-fe`, `../itdasy-release-cert-be-deletion-retry`, `../itdasy-release-cert-report`.
- 최종 판정: RELEASE HOLD. 게이트 PASS 9 / FAIL 0 / NOT VERIFIED 11 / BLOCKED 5.
- 실제 제공판: FE 제품 코드 `8e838842741d`, 실제 빌드 `20260915-2008-146567a`; BE `6866a9d4441c`, Cloud Run `00626-h2n` 100%.
- 전체 검사: FE 206묶음·3,220개 성공. BE 공식 일반·순서 섞기 각 4,615개, 실제 PostgreSQL 214개, 매장 분리 172개+99개, 연결값 검사 모두 성공.
- 격리 DB: 2,365요청, 매장 20곳, 고객 2,628명, 예약 477건, 돈·회원권 규칙 15개 불일치 0. 실제 서버 설정 동시 8·12명에서 5xx 0.
- 스테이징: 사진 저장소 비공개와 삭제 후 차단, 탈퇴 삭제 재시도 열·색인, DB 변경 `0066`, AI 질문 원문 미기록을 실제 확인.
- 수정 완료: 공개 사진, 삭제 실패 은폐·재시도, AI 동의/기록, 매장 직접 DB 접근, 정책·가격, 로그인·돈·DB 검사 문제 등 42건. 최종 검사 중 고객 소개 색인 누락 1건도 수정·재검증.
- 미해결: 실제 동작하는 과거 Google AI 열쇠 1개와 Remove.bg 열쇠 폐기, 실제 Meta·상점 결제, 관리형 DB 복원, 100명/사진 10,000장 성능, 후보 모바일 전 과정, 사람 12명, 실제 원장 6명 스타일 평가, 국외이전·광고 법률 확인.

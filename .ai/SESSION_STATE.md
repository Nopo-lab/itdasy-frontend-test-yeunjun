...
- BE 후보 `88f56e2`: 외부 AI 진입점 31곳을 현재 동의로 막고 DM 재생성 우회를 닫음. Instagram 분석 동의를 전용 2.0으로 분리해 과거 자동 1.0 기록을 거절.
- 전체 검사: FE 206묶음 3,220개 성공, BE 4,591개 성공·291개 미실행·예상 실패 1개. 실제 PostgreSQL 211개 성공.

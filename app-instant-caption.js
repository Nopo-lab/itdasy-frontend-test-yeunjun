...
(function instantCaption() {
  ...
  const SHOP_TAGS = {
    ...
    // [v192 2026-05-18] 신규 6종
    '메이크업': ['메이크업', '데일리메이크업', '웨딩메이크업', '메이크업아티스트', '뷰티스타그램'],
    '눈썹':     ['눈썹정리', '브로우', '눈썹왁싱', '눈썹셰이딩', '뷰티스타그램'],
    '두피탈모': ['두피관리', '탈모케어', '두피스케일링', '두피스타그램', '뷰티스타그램'],
    '패디':     ['패디큐어', '풋케어', '발관리', '페디스타그램', '뷰티스타그램'],
    '바디':     ['바디관리', '전신마사지', '바디케어', '셀룰라이트', '뷰티스타그램'],

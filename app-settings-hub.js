    ...
    sheet.innerHTML = `
      <div id="shCard" style="width:100%;max-width:560px;background:#fff;border-radius:20px 20px 0 0;max-height:92vh;overflow-y:auto;padding:18px 18px max(18px,env(safe-area-inset-bottom));">
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:12px;">
          <strong style="font-size:18px;">⚙️ 설정 · 연동</strong>
          <button id="shClose" aria-label="닫기" style="margin-left:auto;background:none;border:none;font-size:22px;cursor:pointer;line-height:1;">×</button>
        </div>
      ...
      <style>
        ...
        .sh-emoji { font-size: 18px; flex-shrink: 0; }
        .sh-lbl { flex: 1; font-weight: 600; }
        .sh-chev { color: #aaa; font-size: 18px; }
        .sh-badge {
